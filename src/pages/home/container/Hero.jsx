...
const Hero = () => {
  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2 lg:mr-12">
        ...
        Your Path to Beautiful Hair and a Confident You! Explore the tips and
        tricks to achieve stunning, healthy hair that boosts your confidence.
        </p>
